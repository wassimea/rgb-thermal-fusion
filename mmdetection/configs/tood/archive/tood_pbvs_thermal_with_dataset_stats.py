...
rgb_std = [87.42839991, 87.07733285, 87.25576906]
...
data = dict(
    train=dict(
        ...
        pipeline=[
            ...
            dict(
                type='Normalize',
                mean=[135.936, 135.936, 135.936], # [123.675, 116.28, 103.53],
                std=[49.623, 49.623, 49.623], # [58.395, 57.12, 57.375],
                mean_grayscale=[135.936],
                std_grayscale=[49.623],
                to_rgb=True),
